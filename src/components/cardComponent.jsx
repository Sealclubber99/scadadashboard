...
function CardComponent({asset, selectedSize, row}){
        ...
        <div className={classNames({
            ...
            <div className="top_card row d-flex flex-row justify-content-around">
                ...
                <div className="col-4 d-flex flex-column align-items-end">
                    <div className="row ">
                        <p className="primary_text price m-0">${row['gen_lmp']}</p>
                    </div>
                    <div className="col-10 d-flex flex-row justify-content-end">
                        <div className="row ">
                            <p className="price primary_text m-0">{row['gen_soc']}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    <div className="col-4 d-flex flex-column">
                        <div className="row d-flex flex-row justify-content-between">
                            <div className="col-6">
                                <p className="nmw p-0 m-0">{row['gen_basepoint']}</p>
                            </div>
                    ...
                    <div className="col-4 d-flex flex-column">
                        <div className="row d-flex flex-row justify-content-between">
                            ...
                            <div className="col-6 d-flex flex-row justify-content-end">
                                <p className="nmw p-0 m-0">{row['load_basepoint']}</p>
                            </div>
