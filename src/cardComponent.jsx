...
class CardComponent extends Component {
    ...
    //checks if an alert was triggered
    getAlerts() {
        //false on default
        var alerted = false;
        //checks if the list is empty or not
        if (typeof (this.props.rules) != "undefined") {
            //if the list exists it checks to make sure there is alerts set
            if (this.props.rules.length > 0) {
                //cycles through alerts if they exist and checks if they are triggered
                //a switch statement might be more effecient in the future
        ...
        //returns boolean alert is triggered or not t/f
        return alerted;
    }
    ...
    render() {
        ...
        //makes sure it is not dividing by 0
        var char_width, dis_width, load_width, gen_width;
        if (this.props.row['gen_max_charge_mw'] != 0) {
            char_width = ((this.props.row['load_net_mw'] / this.props.row['gen_max_charge_mw']) * .8) * 100
        }
        else{
            char_width = 0;
        }
        if (this.props.row['gen_max_discharge_mw'] != 0) {
            dis_width = ((this.props.row['load_net_mw'] / this.props.row['gen_max_discharge_mw']) * .8) * 100
        }
        else{
            dis_width = 0;
        }
        if(this.state.load_def_hsl != 0){
        ...
        //checks each of the fuses/statuses for the open/closed fuse icons
        ...
        //gets percents from abve function
        var percents = this.getPercents()
        //calls to check alerts again t/f
        var flashing = this.getAlerts();

        //actually populates the card using prop data, pretty self explainatory
        return (
            <div id={this.props.id} className={classNames({
                ...
                <div className="top_card row d-flex flex-row justify-content-around">
                    ...
                    <div className="col-4 d-flex flex-column align-items-end">
                        <div className="row ">
                            <p className="primary_text price m-0"
                               id="gen_price">${Number(this.props.row['gen_lmp']).toFixed(2)}</p>
                        </div>
                        <div className="col-10 d-flex flex-row justify-content-end">
                            <div className="row ">
                                <p className="price primary_text m-0"
                                   id="gen_soc">{Number(this.props.row['gen_soc']).toFixed(2)}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row">
                                <div className="col-4 d-flex flex-column">
                                    <div className="row d-flex flex-row justify-content-between">
                                        <div className="col-6">
                                            <p className="nmw p-0 m-0"
                                               id="gen_basepoint">{Number(this.props.row['gen_basepoint']).toFixed(2)}</p>
                                        </div>
                                        <div
                                            className="col-6 d-flex flex-column justify-content-end align-items-start m-0 p-0">
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        <div className="col-6">
                                            <p className="nmw p-0 m-0"
                                               id="gen_net_mw">{Number(this.props.row['gen_net_mw']).toFixed(2)}</p>
                                        </div>
                                        <div
                                            className="col-6 d-flex flex-column justify-content-end align-items-start m-0 p-0">
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        <div className="col-6 d-flex flex-row justify-content-start">
                                            <p className="reg_text  p-0 m-0"
                                               id="gen_regd_req">{Number(this.props.row['gen_reg_down_requirement']).toFixed(2)}</p>
                                            <p className="secondary_text p-0 m-0"
                                               id="gen_regd_res">/{Number(this.props.row['gen_reg_down_responsibility']).toFixed(2)}</p>
                                        </div>
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        ...
                                        <div className="col-6 d-flex flex-row justify-content-start">
                                            <p className="reg_text  p-0 m-0"
                                               id="gen_regu_req">{Number(this.props.row['gen_reg_up_requirement']).toFixed(2)}</p>
                                            <p className="secondary_text p-0 m-0"
                                               id="gen_regu_res">/{Number(this.props.row['gen_reg_up_responsibility']).toFixed(2)}</p>
                                        </div>
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        <div className="col-6 d-flex flex-row justify-content-start">
                                            <p className="reg_text  p-0 m-0"
                                               id="gen_rrs_req">{Number(this.props.row['gen_rrs_requirement']).toFixed(2)}</p>
                                            <p className="secondary_text p-0 m-0"
                                               id="gen_rrs_res">/{Number(this.props.row['gen_rrs_responsibility']).toFixed(2)}</p>
                                        </div>
                                        <div className="col-6 d-flex flex-row justify-content-start p-0">
                                ...
                                <div className="col-4">
                                    <div className="row">
                                        ...
                                        <div className="container">
                                            <div className="row d-flex flex-row justify-content-center">
                                                <div
                                                    className="col-5 d-flex flex-column justify-content-center align-items-end p-0">
                                                    <div className="bar_left mb-1" id="dis_bar"
                                                         style={{width: dis_width + '%'}}>
                                                    </div>
                                                    <div className="bar_left" id="genudbp"
                                                         style={{width: gen_width + '%'}}>
                                                    </div>
                                                </div>
                                                <div className="vertical_line p-0"></div>
                                                <div
                                                    className="col-5 d-flex flex-column justify-content-center align-items-start p-0">

                                                    <div className="bar_right mb-1" id="char_bar"
                                                         style={{width: char_width + '%'}}>
                                                    </div>
                                                    <div className="bar_right " id="loadudbp"
                                    ...
                                    <div className="row d-flex flex-row justify-content-center pb-3">
                                        <div className="col-4 d-flex flex-row justify-content-start">
                                            <div className="udbp">
                                                <p className="secondary_text p-0 m-0"
                                                   id="gen_upbp">{this.props.row['gen_updated_basepoint']}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-4 d-flex flex-row justify-content-end">
                                            <div className="udbp">
                                                <p className="secondary_text p-0 m-0"
                                                   id="load_upbp">{this.props.row['load_updated_basepoint']}</p>
                                            </div>
                                        </div>
                                ...
                                <div className="col-4 d-flex flex-column">
                                    <div className="row d-flex flex-row justify-content-between">
                                        ...
                                        <div
                                            className="col-6 d-flex flex-column justify-content-end align-items-end m-0 p-0">
                                            <p className="secondary_text pb-1 m-0 ">BP</p>
                                        </div>
                                        <div className="col-6 d-flex flex-row justify-content-end">
                                            <p className="nmw p-0 m-0"
                                               id="load_basepoint">{Number(this.props.row['load_basepoint']).toFixed(2)}</p>
                                        </div>
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        ...
                                        <div className="col-6 d-flex flex-row justify-content-end">
                                            <p className="nmw p-0 m-0 "
                                               id="load_net_mw">{Number(this.props.row['load_net_mw']).toFixed(2)}</p>
                                        </div>
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        ...
                                        <div className="col-6 d-flex flex-row justify-content-end">
                                            <p className="reg_text  p-0 m-0"
                                               id="load_regd_req">{Number(this.props.row['load_reg_down_requirement']).toFixed(2)}</p>
                                            <p className="secondary_text p-0 m-0"
                                               id="load_regd_res">/{Number(this.props.row['load_reg_down_responsibility']).toFixed(2)}</p>
                                        </div>
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        ...
                                        <div className="col-6 d-flex flex-row justify-content-end">
                                            <p className="reg_text  p-0 m-0"
                                               id="load_regu_req">{Number(this.props.row['load_reg_up_requirement']).toFixed(2)}</p>
                                            <p className="secondary_text p-0 m-0"
                                               id="load_regu_res">/{Number(this.props.row['load_reg_up_responsibility']).toFixed(2)}</p>
                                        </div>
                                    ...
                                    <div className="row d-flex flex-row justify-content-between">
                                        ...
                                        <div className="col-6 d-flex flex-row justify-content-end">
                                            <p className="reg_text"
                                               id="load_rrs_req">{Number(this.props.row['load_rrs_requirement']).toFixed(2)}</p>
                                            <p className="secondary_text"
                                               id="load_rrs_res">/{Number(this.props.row['load_rrs_responsibility']).toFixed(2)}</p>
                                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-6 d-flex flex-row justify-content-between">
                                    ...
                                    <div className="col-6 d-flex flex-column justify-content-center align-items-center">
                                        <p className="nmw"
                                           id="gen_max_discharge">{Number(this.props.row['gen_max_discharge_mw']).toFixed(1)} | {Number(this.props.row['gen_max_charge_mw']).toFixed(1)}</p>
                                    </div>
                    ...
                    <div className="card_back">
                        <div className="row ">
                            ...
                            <div className="col-4 d-flex justify-content-center m-0">
                                ...
                                <p className="secondary_text m-0" id="frequency">{Number(this.props.frequency).toFixed(3)}</p>
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">Status:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_res_status">{Number(this.props.row['load_resource_status'])}</p>
                        ...
                        <div className="row ">
                            <div className="col-4 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_basepoint_2">{Number(this.props.row['gen_basepoint']).toFixed(2)}</p>
                            </div>
                            <div className="col-4 d-flex justify-content-center m-0">
                                <p className="secondary_text font-weight-bold m-0">SOC:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="gen_soc_2">{Number(this.props.row['gen_soc']).toFixed(2)}</p>
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">Basepoint:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_basepoint_2">{Number(this.props.row['load_basepoint']).toFixed(2)}</p>
                        ...
                        <div className="row ">
                            <div className="col-4 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_upbp_2">{this.props.row['gen_updated_basepoint']}</p>
                            </div>
                            <div className="col-4 d-flex justify-content-center m-0">
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">UDBP:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_upbp_2">{this.props.row['load_updated_basepoint']}</p>
                        ...
                        <div className="row ">
                            <div className="col-4 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_net_mw_2">{Number(this.props.row['gen_net_mw']).toFixed(2)}</p>
                            </div>
                            <div className="col-4 d-flex justify-content-center m-0">
                            ...
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">Net MW:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_net_mw_2">{Number(this.props.row['load_net_mw']).toFixed(2)}</p>
                        ...
                        <div className="row ">
                            <div className="col-4 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_net_mvar">{Number(this.props.row['gen_net_mvar']).toFixed(2)}</p>
                            </div>
                            <div className="col-4 d-flex justify-content-center m-0">
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">Net MVAR:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_net_mvar">{Number(this.props.row['load_net_mvar']).toFixed(2)}</p>
                        ...
                        <div className="row ">
                            ...
                            <div className="col-4 d-flex justify-content-center m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_max_soc">{Number(this.props.row['gen_max_operating_soc']).toFixed(1)}</p>
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                            </div>
                        ...
                        <div className="row ">
                            ...
                            <div className="col-4 d-flex justify-content-center m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_min_soc">{Number(this.props.row['gen_min_operating_soc']).toFixed(1)}</p>
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0 warning_col">HSL:&nbsp;</p>
                        ...
                        <div className="row ">
                            ...
                            <div className="col-8 d-flex justify-content-center m-0">
                                <p className="secondary_text font-weight-bold m-0">Max Discharge Power
                                    Limit:&nbsp;</p>
                        ...
                        <div className="row">
                            <div className="col-4 d-flex flex-row justify-content-start m-0 unrow_r">
                                <p className="secondary_text font-weight-bold m-0 warning_col ">SCCT Mitigation
                                    Flag:&nbsp;</p>
                                <p className="secondary_text m-0 warning_col"
                                   id="gen_scct">{this.props.row['gen_scct_flag']}</p>
                            </div>
                            <div className="col-4 d-flex justify-content-center m-0">
                                <p className="secondary_text font-weight-bold m-0">Breaker 52M:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="gen_52m">{this.props.row['gen_52m_status']}</p>
                            </div>
                            <div className="col-4  d-flex flex-row justify-content-end m-0 unrow_l">
                                <p className="secondary_text font-weight-bold m-0 warning_col ">SCCT Mitigation
                                    Flag:&nbsp;</p>
                                <p className="secondary_text m-0 warning_col"
                                   id="load_scct">{this.props.row['load_scct_flag']}</p>
                            </div>
                        ...
                        <div className="row ">
                            ...
                            <div className="col-6 d-flex justify-content-center m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_breaker">{this.props.row['gen_pseudo_switch_status']}</p>
                            </div>
                            <div className="col-3  d-flex flex-row justify-content-end m-0">
                        ...
                        <div className="row ">
                            <div className="col-3 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_flows">{Number(this.props.row['gen_line_flows_mw']).toFixed(1)}</p>
                            </div>
                            <div className="col-6 d-flex justify-content-center m-0">
                                <p className="secondary_text font-weight-bold m-0 warning_col">Breaker
                                    Load:&nbsp;</p>
                                <p className="secondary_text m-0 warning_col"
                                   id="load_breaker">{Number(this.props.row['load_pseudo_switch_status']).toFixed(1)}</p>
                            </div>
                            <div className="col-3  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">Line MW:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_flows">{Number(this.props.row['load_lines_flows_mw']).toFixed(1)}</p>
                        ...
                        <div className="row ">
                            <div className="col-6 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_flows_mvar">{Number(this.props.row['gen_line_flows_mvar']).toFixed(1)}</p>
                            </div>
                            <div className="col-6  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">Line MVAW:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_flows_mvar">{Number(this.props.row['load_line_flows_mvar']).toFixed(1)}</p>
                        ...
                        <div className="row ">
                            <div className="col-6 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_voltage">{Number(this.props.row['gen_voltage']).toFixed(1)}</p>
                            </div>
                            <div className="col-6  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">VAB Voltage:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_voltage">{Number(this.props.row['load_voltage']).toFixed(1)}</p>
                        ...
                        <div className="row ">
                            <div className="col-6 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_nurr">{Number(this.props.row['gen_normal_up_ramp_rate']).toFixed(1)}</p>
                            </div>
                            <div className="col-6  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">NURR:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_nurr">{Number(this.props.row['load_normal_up_ramp_rate']).toFixed(1)}</p>
                        ...
                        <div className="row ">
                            <div className="col-6 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_ndrr">{Number(this.props.row['gen_normal_down_ramp_rate']).toFixed(1)}</p>
                            </div>
                            <div className="col-6  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">NDRR:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_ndrr">{Number(this.props.row['load_normal_down_ramp_rate']).toFixed(1)}</p>
                        ...
                        <div className="row ">
                            <div className="col-6 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_eurr">{Number(this.props.row['gen_emergency_up_ramp_rate']).toFixed(1)}</p>
                            </div>
                            <div className="col-6  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">EURR:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_eurr">{Number(this.props.row['load_emergency_up_ramp_rate']).toFixed(1)}</p>
                        ...
                        <div className="row ">
                            <div className="col-6 d-flex flex-row justify-content-start m-0">
                                ...
                                <p className="secondary_text m-0"
                                   id="gen_edrr">{Number(this.props.row['gen_emergency_down_ramp_rate']).toFixed(1)}</p>
                            </div>
                            <div className="col-6  d-flex flex-row justify-content-end m-0">
                                <p className="secondary_text font-weight-bold m-0">EDRR:&nbsp;</p>
                                <p className="secondary_text m-0"
                                   id="load_edrr">{Number(this.props.row['load_emergency_down_ramp_rate']).toFixed(1)}</p>
